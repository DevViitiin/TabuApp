...
class _HomeScreen extends State<HomeScreen>
  ...
  Future<void> _carregarMaisPosts() async {
    ...
    try {
      ...
      if (mounted)
        setState(() {
          if (novos.isNotEmpty) _posts.addAll(novos);
          _loadingMore = false;
        });
    } catch (e) {
  ...
  Widget _buildAppBar(String name, String avatarUrl) {
    return Padding(
      ...
      child: Row(children: [
        ...
        GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _menuOpen ? TabuColors.rosaPrincipal : TabuColors.borderMid,
                width: 0.8,
              ),
            ),
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              AnimatedRotation(
                ...
                duration: const Duration(milliseconds: 260),
                child: const Icon(Icons.add, color: TabuColors.branco, size: 16),
              ),
              const SizedBox(width: 8),
              const Text('CRIAR', style: TextStyle(
        ...
        _SquircleAvatar(
          size: 36, radius: 8, avatarUrl: avatarUrl,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  ...
                  BoxShadow(
                    color: TabuColors.glow.withOpacity(0.15), blurRadius: 16,
                  ),
                ],
              ),
  ...
  Widget _buildCreateBox(String avatarUrl) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          _SquircleAvatar(
            size: 40, radius: 9, avatarUrl: avatarUrl,
            gradient: const [TabuColors.rosaDeep, TabuColors.rosaPrincipal],
          ...
          Expanded(
            child: Container(
              ...
              child: const Text('O que está rolando?', style: TextStyle(
                fontFamily: TabuTypography.bodyFont,
                fontSize: 13, color: TabuColors.subtle, letterSpacing: 0.3,
              )),
            ),
          ),
          const SizedBox(width: 10),
  ...
  Widget _buildFestasSection() {
    ...
    if (!_loadingFestas && festasVisiveis.isEmpty) return const SizedBox.shrink();
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Row(children: [
          ...
          const SizedBox(width: 8),
          const Text('FESTAS', style: TextStyle(
            fontFamily: TabuTypography.bodyFont, fontSize: 9,
            fontWeight: FontWeight.w700, letterSpacing: 3,
            color: TabuColors.rosaPrincipal,
          )),
          const SizedBox(width: 8),
          if (!_loadingFestas && _homeCoords != null && festasVisiveis.isNotEmpty)
            Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                Text('${festasVisiveis.length} PRÓXIMAS', style: const TextStyle(
        ...
        SizedBox(
          ...
          child: Center(
            child: SizedBox(
              width: 18, height: 18,
              child: CircularProgressIndicator(
                color: TabuColors.rosaPrincipal.withOpacity(0.5), strokeWidth: 1.5,
              ),
            ),
          ),
        )
                  ...
                  if (i == 0) {
                    return _StoryBubble(
                      ...
                      name: UserDataNotifier.instance.nameUpper.isNotEmpty
                          ...
                          : (widget.userData['name'] as String? ?? 'EU').toUpperCase(),
  ...
  Widget _buildPostsVazio() {
    return Padding(
      ...
      child: Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          const Icon(Icons.dynamic_feed_rounded, color: TabuColors.border, size: 48),
          const SizedBox(height: 16),
          const Text('NENHUM POST AINDA', style: TextStyle(
            fontFamily: TabuTypography.bodyFont, fontSize: 11,
            fontWeight: FontWeight.w700, letterSpacing: 3, color: TabuColors.subtle,
          )),
          const SizedBox(height: 8),
          const Text('Seja o primeiro a publicar!', style: TextStyle(
...
class _FestaCard extends StatelessWidget {
  ...
  const _FestaCard({
    required this.festa, required this.myUid, required this.isAdmin,
    required this.userData, required this.homeCoords, required this.onRefresh,
  });
      ...
      onTap: () {
        ...
        showModalBottomSheet(
          ...
          builder: (_) => _FestaDetailSheet(
            festa: festa, myUid: myUid, isAdmin: isAdmin,
            userData: userData, homeCoords: homeCoords, onRefresh: onRefresh,
          ),
        );
      },
      child: Container(
                ...
                children: [
                  Container(
                    ...
                    child: Text(_fd(festa.dataInicio), style: const TextStyle(
                      fontFamily: TabuTypography.bodyFont, fontSize: 8,
                      fontWeight: FontWeight.w700, letterSpacing: 2, color: Colors.white,
                    )),
                  ),
                  ...
                  Text(festa.nome.toUpperCase(),
                    ...
                    style: const TextStyle(
                      ...
                      letterSpacing: 1.5, color: Colors.white, height: 1.2,
                    )),
  ...
  Widget build(BuildContext context) =>
      Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text('$count $label', style: const TextStyle(
          fontFamily: TabuTypography.bodyFont, fontSize: 8,
          letterSpacing: 0.3, color: Colors.white54,
        )),
      ]);
}
            ...
            Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(festa.nome.toUpperCase(), style: const TextStyle(
                  fontFamily: TabuTypography.displayFont, fontSize: 26,
                  letterSpacing: 3, color: TabuColors.branco,
                )),
                const SizedBox(height: 10),
                Row(children: [
                  Icon(
                    festa.hasLocal ? Icons.location_on_outlined : Icons.location_off_outlined,
                ...
                Row(children: [
                  ...
                  Text('${_fh(festa.dataInicio)} – ${_fh(festa.dataFim)}',
                    style: const TextStyle(
                      fontFamily: TabuTypography.bodyFont, fontSize: 12, color: TabuColors.dim,
                    )),
                ]),
                ...
                if (_loadingComs)
                  ...
                  const Padding(
                    ...
                    child: Text('Seja o primeiro a comentar', style: TextStyle(
                      fontFamily: TabuTypography.bodyFont, fontSize: 11, color: TabuColors.subtle,
                    )),
                  )
                else
...
// ══════════════════════════════════════════════════════════════════════════════
//  POST CARD — usa UserProfileCache para nome e avatar sempre frescos
// ══════════════════════════════════════════════════════════════════════════════
class _PostCard extends StatefulWidget {
  ...
  final Map<String, dynamic> userData;
  const _PostCard({
    required this.post, required this.uid, required this.userData, super.key,
  });
  @override
...
class _PostCardState extends State<_PostCard> {
  ...
  // ── campos vivos de perfil ─────────────────────────────────────────────────
  // Inicializados com o snapshot do post (exibição imediata, sem piscar)
  ...
  void initState() {
    ...
    // Inicializa com snapshot (fallback imediato)
    _liveUserName   = widget.post.userName;
    _liveUserAvatar = widget.post.userAvatar ?? '';

    // Se for o próprio usuário, usa o notifier (já em memória, sempre atualizado)
    if (_isOwnPost) {
    ...
    if (widget.post.tipo == 'video' && widget.post.mediaUrl != null) {
      VideoPreloadService.instance.preload(widget.post.id, widget.post.mediaUrl!);
    }
  }
  ...
  /// Busca nome e avatar frescos do UserProfileCache.
  /// Para o próprio usuário o UserDataNotifier já foi usado no initState,
  /// mas chamamos o cache mesmo assim para manter consistência.
  Future<void> _loadLiveProfile() async {
    // Tenta do cache síncrono primeiro (sem rebuild desnecessário)
    final cached = UserProfileCache.instance.getCached(widget.post.userId);
    if (cached != null) {
      final newName   = cached.name.isNotEmpty   ? cached.name   : _liveUserName;
      final newAvatar = cached.avatar.isNotEmpty ? cached.avatar : _liveUserAvatar;
      if (newName != _liveUserName || newAvatar != _liveUserAvatar) {
        if (mounted) setState(() { _liveUserName = newName; _liveUserAvatar = newAvatar; });
      }
      return;
    }
    // Busca assíncrona (primeira vez que este uid aparece na sessão)
    final profile = await UserProfileCache.instance.fetch(widget.post.userId);
    if (!mounted) return;
    final newName   = profile.name.isNotEmpty   ? profile.name   : _liveUserName;
    final newAvatar = profile.avatar.isNotEmpty ? profile.avatar : _liveUserAvatar;
    if (newName != _liveUserName || newAvatar != _liveUserAvatar) {
      setState(() { _liveUserName = newName; _liveUserAvatar = newAvatar; });
    }
  }
    ...
    showModalBottomSheet(
      ...
      builder: (_) => SafeArea(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Text('EXCLUIR POST?', style: TextStyle(
            fontFamily: TabuTypography.displayFont, fontSize: 14,
            letterSpacing: 4, color: TabuColors.branco,
          )),
          const SizedBox(height: 8),
          const Text('Esta ação não pode ser desfeita.', style: TextStyle(
            fontFamily: TabuTypography.bodyFont, fontSize: 12, color: TabuColors.subtle,
          )),
          const SizedBox(height: 20),
          Padding(
            ...
            child: Row(children: [
              Expanded(child: GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Center(child: Text('CANCELAR', style: TextStyle(
                    fontFamily: TabuTypography.bodyFont, fontSize: 11,
                    fontWeight: FontWeight.w700, letterSpacing: 2.5, color: TabuColors.dim,
                  ))),
                ),
              )),
              const SizedBox(width: 12),
              Expanded(child: GestureDetector(
                ...
                child: Container(
                  height: 46, color: const Color(0xFFE85D5D),
                  child: const Center(child: Text('EXCLUIR', style: TextStyle(
                    fontFamily: TabuTypography.bodyFont, fontSize: 11,
                    fontWeight: FontWeight.w700, letterSpacing: 2.5, color: Colors.white,
                  ))),
                ),
              )),
            ]),
  ...
  Widget build(BuildContext context) {
    ...
    final temMidia = (isPhoto && post.mediaUrl != null) ||
        (isVideo && post.mediaUrl != null) || isEmoji;
        ...
        Padding(
          ...
          child: Row(children: [
            GestureDetector(
              onTap: _abrirPerfil,
              child: Stack(children: [
                // CachedAvatar já busca por uid — sempre atualizado
                CachedAvatar(
                  uid: post.userId, name: _liveUserName,
                  size: 48, radius: 12,
                  isOwn: _isOwnPost, glowRing: _isOwnPost,
                ),
                if (_isVip)
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  GestureDetector(
                    onTap: _abrirPerfil,
                    // ← NOME VIVO: usa _liveUserName (sempre atualizado via cache)
                    child: Text(_liveUserName, style: const TextStyle(
                      fontFamily: TabuTypography.bodyFont, fontSize: 13,
                      fontWeight: FontWeight.w700, letterSpacing: 1.5,
                      color: TabuColors.branco,
                    )),
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Stack(fit: StackFit.expand, children: [
            Image.network(
              post.mediaUrl!, fit: BoxFit.cover, width: double.infinity,
...
class _VideoThumbnailCard extends StatelessWidget {
  ...
  const _VideoThumbnailCard({
    required this.postId, required this.videoUrl,
    required this.gradient, required this.onTap,
    this.thumbUrl, this.duration,
  });
              ...
              if (isPreloaded) ...[
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: const Color(0xFF4ECDC4).withOpacity(0.6), width: 0.8),
                  ),
                  child: Row(mainAxisSize: MainAxisSize.min, children: const [
                    Icon(Icons.bolt_rounded, color: Color(0xFF4ECDC4), size: 9),
                    SizedBox(width: 3),
              ...
              if (duration != null)
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    const SizedBox(width: 4),
                    Text(_fmtDuration(duration!), style: const TextStyle(
                      fontFamily: TabuTypography.bodyFont, fontSize: 10,
...
class _PB extends StatelessWidget {
  ...
  final bool ativo, loading; final Color color; final VoidCallback onTap;
  const _PB({
      ...
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            const SizedBox(width: 8),
            Text(tempo, style: const TextStyle(
              fontFamily: TabuTypography.bodyFont, fontSize: 9, color: TabuColors.subtle,
            )),
          ]),
    ...
    child: Padding(
      ...
      child: Row(children: [
        Container(
          ...
          child: Icon(icon, color: accent ? TabuColors.rosaPrincipal : TabuColors.dim, size: 16),
        ),
        const SizedBox(width: 12),
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(label, style: TextStyle(
...
class _SquircleAvatar extends StatelessWidget {
  ...
  const _SquircleAvatar({
    required this.size, required this.radius, required this.avatarUrl,
    required this.gradient, required this.ringColor, this.hasNewStory = false,
  });
  @override
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: hasNewStory
          ? [BoxShadow(color: TabuColors.glow, blurRadius: 10, spreadRadius: 1)]
          : null,
    ),
...
class _StoryBubble extends StatelessWidget {
  ...
  const _StoryBubble({
    ...
    required this.isOwn, required this.hasNew, required this.userData,
    required this.onTap, this.viewed = false, this.isVip = false, super.key,
  });
                  ...
                  if (isVip && hasNew && !viewed)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: const LinearGradient(
                          colors: [Color(0xFF6B4A00), Color(0xFFD4AF37),
                                   Color(0xFFFFE066), Color(0xFFD4AF37)],
                          begin: Alignment.topLeft, end: Alignment.bottomRight,
                        ),
                        boxShadow: const [
                          BoxShadow(
                            color: Color(0xFFD4AF37), blurRadius: 14,
                            spreadRadius: 1, blurStyle: BlurStyle.outer,
                          ),
                        ],
                      ),
                    )
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(color: TabuColors.glow, blurRadius: 12, spreadRadius: 1),
                        ],
                      ),
                    )
                  else if (hasNew && viewed)
  ...
  Widget _avatarPlaceholder() => Container(
    ...
    child: isOwn
        ...
        : Center(child: Text(
            ...
            style: const TextStyle(
              fontFamily: TabuTypography.displayFont, fontSize: 22, color: Colors.white,
            ),
          )),
  );
}
    ...
    child: GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(label, style: TextStyle(
            fontFamily: TabuTypography.bodyFont, fontSize: 10,
            fontWeight: FontWeight.w600, letterSpacing: 1.5, color: color,
          )),
        ]),
      ),
    ),
