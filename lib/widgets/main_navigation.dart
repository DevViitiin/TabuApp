...
class _TabuShellState extends State<TabuShell> {
  ...
  void initState() {
    super.initState();
    _screens = [
      HomeScreen(userData: widget.userData),   // 0 — Feed
      const _FestaPlaceholder(),               // 1 — Festas
      const _ChatPlaceholder(),                // 2 — Chat
      PerfilScreen(userData: widget.userData), // 3 — Perfil
    ];
  }
...
// ════════════════════════════════════════════
//  PLACEHOLDERS — substitua pelas telas reais
// ════════════════════════════════════════════
class _FestaPlaceholder extends StatelessWidget {
  const _FestaPlaceholder();
  @override
  Widget build(BuildContext context) =>
      const _PlaceholderScreen(label: 'FESTAS', icon: Icons.local_fire_department);
}
...
class _ChatPlaceholder extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _PlaceholderScreen(label: 'CHAT', icon: Icons.chat_bubble_outline);
}
